...
public struct JMTimelineCompositeTaskStyle: JMTimelineStyle {
...
final class JMTimelineCompositeTaskBlock: UIView, JMTimelineBlock {
    ...
    func apply(style: JMTimelineStyle) {
        let style = style.convert(to: JMTimelineCompositeTaskStyle.self)
        self.style = style
...
fileprivate struct Layout {
    ...
    var briefLabelFrame: CGRect {
        ...
        let size = briefLabel.size(for: bounds.width - 8 - leftX)
    ...
    var agentNameFrame: CGRect {
        ...
        let height = agentNameLabel.calculateHeight(for: width)
    ...
    var dateLabelFrame: CGRect {
        ...
        let leftX = contentLeftX
        let size = dateLabel.size(for: bounds.width - leftX)
