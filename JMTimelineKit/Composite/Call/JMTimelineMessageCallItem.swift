...
public struct JMTimelineMessageCallInfo: JMTimelineInfo {
...
public struct JMTimelineCallStyle: JMTimelineStyle {
    ...
    public init(stateColor: UIColor,
                stateFont: UIFont,
...
public class JMTimelineMessageCallItem: JMTimelineMessageItem {
}
